...
- `[I]` [Carbon.HTTP.Parser.Class](#Carbon-HTTP-Parser-Class)
...
- `[C]` [Carbon.JSONLD.Parser.Class](#Carbon-JSONLD-Parser-Class)
...
- `[C]` [Carbon.SPARQL.RawResults.ValueTypes](#Carbon-SPARQL-RawResults-ValueTypes)
...
**Extends:** [Carbon.AbstractContext.Class](#Carbon-AbstractContext-Class)
...
**Extends:** [Carbon.Auth.Roles.Class](#Carbon-Auth-Roles-Class)
...
##### create
```typescript 
static create( name:string ):Carbon.App.Role.Class
```
...
##### createFrom
```typescript 
static createFrom( object:T extends Object,  name:string ):T & Carbon.App.Role.Class
```
...
##### decorate
```typescript 
static decorate<T extends Object>( object:T ):T & Carbon.Auth.Token.Class
```
...
**Default export:** [Carbon.HTTP.Parser.Class](#Carbon-HTTP-Parser-Class)





### <a name="Carbon-HTTP-Parser-Class"/>Interface Carbon.HTTP.Parser.Class


> Interface that represents a what a parser must contains to be used when converting the response of a request.


#### <a name="Carbon-HTTP-Parser-Class-Methods"/>Methods
##### parse
```typescript 
...
## <a name="Module-Carbon-JSONLD-Parser"/>Module Carbon/JSONLD/Parser


**Default export:** [Carbon.JSONLD.Parser.Class](#Carbon-JSONLD-Parser-Class)
...
#### <a name="Carbon-JSONLD-Parser-Class-Methods"/>Methods
...
### <a name="Carbon-ObjectSchema-Resolver"/>Interface Carbon.ObjectSchema.Resolver


> Interface that defines the methods needed for an element that can provide object schemas.


#### <a name="Carbon-ObjectSchema-Resolver-Methods"/>Methods
##### getGeneralSchema
```typescript 
getGeneralSchema():Carbon.ObjectSchema.DigestedObjectSchema
```
...
##### getSchemaFor
```typescript 
getSchemaFor( object:Object ):Carbon.ObjectSchema.DigestedObjectSchema
```
...
- object: The object to look for its schema.
...
### <a name="Carbon-SPARQL-RawResults-ValueTypes"/>Class Carbon.SPARQL.RawResults.ValueTypes
...
#### <a name="Carbon-SPARQL-RawResults-ValueTypes-Properties"/>Properties
```typescript 
static BNODE:string 
```
