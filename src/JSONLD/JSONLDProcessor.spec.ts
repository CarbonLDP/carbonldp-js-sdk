...
describe( "JSONLDProcessor", ():void => {
	...
	describe( "JSONLDProcessor.expand", () => {
		...
		it( "should expand equally than library `jsonld`", async () => {
			...
			for( const object of objects ) {
				const libExpand:object = await jsonldExpand( object );
				const myExpand:object = await JSONLDProcessor.expand( object );
