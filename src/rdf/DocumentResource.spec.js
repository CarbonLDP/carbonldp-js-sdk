define(["require", "exports", './DocumentResource', './FragmentResource', './Resource', '../Utils'], function (require, exports, DocumentResource, FragmentResource, Resource, Utils) {
        ...
        describe('DocumentResource', function () {
            ...
            describe('Class', function () {
                ...
                it("has method, getFragments( uri ), that returns the document resource's fragment with that uri, or null if it doesn't exist.", function () {
                    ...
                    var resourceFragments = documentResource.getFragments();
                ...
                it("has method, createFragment( uri ), that creates a fragment in the documentResource and returns it.", function () {
                    ...
                    var fragment = documentResource.createFragment('#new-fragment');
...
//# sourceMappingURL=DocumentResource.spec.js.map