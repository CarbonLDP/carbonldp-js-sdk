define(["require", "exports", '../Utils', '../namespaces/XSD', './Resource'], function (require, exports, Utils, XSD, Resource) {
    describe('Resource.Factory', function () {
        ...
        it("has static method, injectDescriptions( resource, descriptions ), which injects properties that get/set uri properties to the object", function () {
            ...
            var resource = Resource.Factory.from(object);
            var post = Resource.Factory.injectDescriptions(resource, descriptions);
            ...
            var comment = { '@id': 'http://example.com/posts/1/comments/4/' };
