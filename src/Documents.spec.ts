	...
	describe( clazz(
		...
		describe( method( INSTANCE, "createChildrenAndRetrieve" ), ():void => {
			...
			it( hasSignature(
				...
				{ type: "Promise<[ (T & Carbon.PersistedProtectedDocument.Class)[], [ Carbon.HTTP.Response.Response[], Carbon.HTTP.Response.Response[] ] ]>", description: "Promise that contains a tuple with an array of the new and resolved persisted children, and another tuple with two arrays containing the response class of every request." }
			), ():void => {} );
		...
		describe( method( INSTANCE, "listChildren" ), () => {
			...
			it( hasSignature(
				...
				{ type: "Promise<[ Carbon.PersistedDocument.Class[], Carbon.HTTP.Response.Response ]>" }
			), () => {} );
		...
		describe( method( INSTANCE, "createAccessPoint" ), ():void => {
			...
			it( hasSignature(
				...
				{ type: "Promise<[ T & Carbon.PersistedAccessPoint.Class, Carbon.HTTP.Response.Response ]>" }
			), ():void => {} );
