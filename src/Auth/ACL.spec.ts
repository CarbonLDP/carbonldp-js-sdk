...
describe( module( "Carbon/Auth/ACL" ), ():void => {
	...
	describe( interfaze(
		...
		it( hasMethod(
			OBLIGATORY,
			"isDecorated",
			"Return true if the object provided has the properties and methods of a `Carbon.Auth.ACL.ACL` object.", [
				{ name: "object", type: "object", description: "The object to analise." },
			],
			{ type: "object is Carbon.Auth.ACL.ACL" }
		), ():void => {} );
		...
		it( hasMethod(
			...
			"decorate",
			[ "T extends object" ],
			"Decorate the object with the methods o a `Carbon.Auth.ACL.ACL` object.", [
	...
	it( hasDefaultExport( "Carbon.Auth.ACL.ACL" ), ():void => {
