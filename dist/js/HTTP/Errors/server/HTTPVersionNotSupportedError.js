...
System.register(["./../HTTPError"], function (_export, _context) {
    var HTTPError, _createClass, name, statusCode, HTTPVersionNotSupportedError;
    ...
    return {
        ...
        execute: function () {
            ...
            HTTPVersionNotSupportedError = function (_HTTPError) {
                ...
                function HTTPVersionNotSupportedError() {
                    ...
                    return _possibleConstructorReturn(this, Object.getPrototypeOf(HTTPVersionNotSupportedError).apply(this, arguments));
                }

                _createClass(HTTPVersionNotSupportedError, [{
                    key: "name",
                    get: function get() {
                        return name;
                    }
            ...
            _export("default", HTTPVersionNotSupportedError);
        }
    };
});
