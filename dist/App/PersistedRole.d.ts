...
export interface Class extends PersistedRole.Class {
    ...
    createChildren<T>(roles: (T & AppRole.Class)[], requestOptions?: HTTP.Request.Options): Promise<[(T & Class)[], [HTTP.Response.Class[], HTTP.Response.Class]]>;
    createChildren<T>(roles: (T & AppRole.Class)[], slugs?: string[], requestOptions?: HTTP.Request.Options): Promise<[(T & Class)[], [HTTP.Response.Class[], HTTP.Response.Class]]>;
