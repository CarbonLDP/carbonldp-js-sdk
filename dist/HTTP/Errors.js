...
var BadRequestError_1 = __importDefault(require("./Errors/client/BadRequestError"));
exports.BadRequestError = BadRequestError_1.default;
var ConflictError_1 = __importDefault(require("./Errors/client/ConflictError"));
exports.ConflictError = ConflictError_1.default;
var ForbiddenError_1 = __importDefault(require("./Errors/client/ForbiddenError"));
exports.ForbiddenError = ForbiddenError_1.default;
var MethodNotAllowedError_1 = __importDefault(require("./Errors/client/MethodNotAllowedError"));
exports.MethodNotAllowedError = MethodNotAllowedError_1.default;
var NotAcceptableError_1 = __importDefault(require("./Errors/client/NotAcceptableError"));
exports.NotAcceptableError = NotAcceptableError_1.default;
var NotFoundError_1 = __importDefault(require("./Errors/client/NotFoundError"));
exports.NotFoundError = NotFoundError_1.default;
var PreconditionFailedError_1 = __importDefault(require("./Errors/client/PreconditionFailedError"));
exports.PreconditionFailedError = PreconditionFailedError_1.default;
var PreconditionRequiredError_1 = __importDefault(require("./Errors/client/PreconditionRequiredError"));
exports.PreconditionRequiredError = PreconditionRequiredError_1.default;
var RequestEntityTooLargeError_1 = __importDefault(require("./Errors/client/RequestEntityTooLargeError"));
exports.RequestEntityTooLargeError = RequestEntityTooLargeError_1.default;
var RequestHeaderFieldsTooLargeError_1 = __importDefault(require("./Errors/client/RequestHeaderFieldsTooLargeError"));
exports.RequestHeaderFieldsTooLargeError = RequestHeaderFieldsTooLargeError_1.default;
var RequestURITooLongError_1 = __importDefault(require("./Errors/client/RequestURITooLongError"));
exports.RequestURITooLongError = RequestURITooLongError_1.default;
var TooManyRequestsError_1 = __importDefault(require("./Errors/client/TooManyRequestsError"));
exports.TooManyRequestsError = TooManyRequestsError_1.default;
var UnauthorizedError_1 = __importDefault(require("./Errors/client/UnauthorizedError"));
exports.UnauthorizedError = UnauthorizedError_1.default;
var UnsupportedMediaTypeError_1 = __importDefault(require("./Errors/client/UnsupportedMediaTypeError"));
exports.UnsupportedMediaTypeError = UnsupportedMediaTypeError_1.default;
var BadResponseError_1 = __importDefault(require("./Errors/server/BadResponseError"));
exports.BadResponseError = BadResponseError_1.default;
var BadGatewayError_1 = __importDefault(require("./Errors/server/BadGatewayError"));
exports.BadGatewayError = BadGatewayError_1.default;
var GatewayTimeoutError_1 = __importDefault(require("./Errors/server/GatewayTimeoutError"));
exports.GatewayTimeoutError = GatewayTimeoutError_1.default;
var HTTPVersionNotSupportedError_1 = __importDefault(require("./Errors/server/HTTPVersionNotSupportedError"));
exports.HTTPVersionNotSupportedError = HTTPVersionNotSupportedError_1.default;
var InternalServerErrorError_1 = __importDefault(require("./Errors/server/InternalServerErrorError"));
exports.InternalServerErrorError = InternalServerErrorError_1.default;
var NotImplementedError_1 = __importDefault(require("./Errors/server/NotImplementedError"));
exports.NotImplementedError = NotImplementedError_1.default;
var ServiceUnavailableError_1 = __importDefault(require("./Errors/server/ServiceUnavailableError"));
exports.ServiceUnavailableError = ServiceUnavailableError_1.default;
var UnknownError_1 = __importDefault(require("./Errors/UnknownError"));
