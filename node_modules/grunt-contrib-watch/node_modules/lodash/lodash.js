...
;(function() {
  ...
  function runInContext(context) {
     ...
     *
     * For more information on precompiling views see:
     ...
     * }
     *
     * // using the `source` property to inline compiled views for meaningful
    ...
    function template(text, data, options) {
      ...
      // inlining compiled views during the build process
