...
var RDFList = require("./../RDF/List");
var AbstractContext_1 = require("./../AbstractContext");
var XSD = require("./../NS/XSD");
var Value = require("./Value");
describe(JasmineExtender_1.module("Carbon/RDF/Value"), function () {
    it(JasmineExtender_1.isDefined(), function () {
        expect(Value).toBeDefined();
        expect(Utils.isObject(Value)).toBe(true);
    });
    describe(JasmineExtender_1.clazz("Carbon.RDF.Value.Util", "Class with useful functions for manage RDF Values."), function () {
        var expandedObject;
        ...
        it(JasmineExtender_1.hasMethod(JasmineExtender_1.STATIC, "areEqual", "Returns true if the two Values are considered equal.", [
            ...
            var value1 = undefined, value2 = undefined;
            var result;
        ...
        it(JasmineExtender_1.hasMethod(JasmineExtender_1.STATIC, "getProperty", "Returns the property searched, parsed in accordance to the RDF object it is.\n" +
        ...
        it(JasmineExtender_1.hasMethod(JasmineExtender_1.STATIC, "getPropertyPointer", "Returns the property searched as a Pointer.\n" +
        ...
        it(JasmineExtender_1.hasMethod(JasmineExtender_1.STATIC, "getPropertyLiteral", "Returns the property searched as a javascript variable. The property must be an RDF Literal.\n" +
        ...
        it(JasmineExtender_1.hasMethod(JasmineExtender_1.STATIC, "getPropertyList", "Returns the property searched as an Array with every element parsed to its respective type of element.\n" +
            "Returns null if the property is not found or cannot be parsed.", [
            { name: "expandedObject", type: "any" },
            { name: "propertyURI", type: "string" },
            { name: "pointerLibrary", type: "Carbon.Pointer.Library" }
        ...
        it(JasmineExtender_1.hasMethod(JasmineExtender_1.STATIC, "getPropertyPointerList", "Returns the property list searched as an Array of Pointers. It will be filtered no pointer values.\n" +
        ...
        it(JasmineExtender_1.hasMethod(JasmineExtender_1.STATIC, "getPropertyLiteralList", "Returns the property list searched as an Array of parsed Literals. It will be filtered no Literal values with the type specified.\n" +
            "Returns null if the property is not found or is not a List.", [
            { name: "expandedObject", type: "any" },
            { name: "propertyURI", type: "string" },
            { name: "pointerLibrary", type: "Carbon.Pointer.Library" }
        ...
        it(JasmineExtender_1.hasMethod(JasmineExtender_1.STATIC, "getProperties", "Returns the property searched as an Array with the parsed Literal, Pointer or List.\n" +
        ...
        it(JasmineExtender_1.hasMethod(JasmineExtender_1.STATIC, "getPropertyPointers", "Returns the property searched as an Array with the parsed Pointer.\n" +
        ...
        it(JasmineExtender_1.hasMethod(JasmineExtender_1.STATIC, "getPropertyURIs", "Returns the URIs of the property searched.\n" +
        ...
        it(JasmineExtender_1.hasMethod(JasmineExtender_1.STATIC, "getPropertyLiterals", "Returns the property searched as an Array with the parsed Literal.\n" +
            "Returns null if the property is not found, or an empty array if cannot be parsed.", [
            { name: "expandedObject", type: "any" },
            { name: "propertyURI", type: "string" },
            { name: "literalType", type: "string" }
        ...
        it(JasmineExtender_1.hasMethod(JasmineExtender_1.STATIC, "getPropertyLanguageMap", "Returns an object associating the language with the parsed string literal.\n" +
        ...
        it(JasmineExtender_1.hasMethod(JasmineExtender_1.STATIC, "getList", "Returns the List object from the provided property of an expanded JSON-LD object.\n" +
            "Returns null if no List object is found.", [
            { name: "propertyValues", type: "Array<any>" }
        ], { type: "Carbon.RDF.List.Class" }), function () {
        ...
        it(JasmineExtender_1.hasMethod(JasmineExtender_1.STATIC, "parseValue", "Returns the parsed object from an Literal, Node, or List.\n" +
