...
describe(JasmineExtender_1.module("Carbon/RDF/Literal"), function () {
    it(JasmineExtender_1.isDefined(), function () {
        expect(Literal).toBeDefined();
        expect(Utils.isObject(Literal)).toBe(true);
    });
    describe(JasmineExtender_1.clazz("Carbon.RDF.Literal.Factory", "Class Factory to manage creation and management of Literal objects."), function () {
        it(JasmineExtender_1.isDefined(), function () {
            expect(Literal.Factory).toBeDefined();
            expect(Utils.isFunction(Literal.Factory)).toBe(true);
        });
        it(JasmineExtender_1.hasMethod(JasmineExtender_1.STATIC, "from", "Convert the value provided to a Literal object."), function () {
        ...
        it(JasmineExtender_1.hasMethod(JasmineExtender_1.STATIC, "parse", "Parse the Literal object to the respective JavaScript type.\n" +
            ...
            var literal;
            var result;
            literal = new Object({ "@type": XSD.DataType.object });
            expect(Literal.Factory.parse(literal)).toBeNull();
            literal = new Object({ "@another": "property" });
            expect(Literal.Factory.parse(literal)).toBeNull();
            literal = {};
            expect(Literal.Factory.parse(literal)).toBeNull();
        ...
        it(JasmineExtender_1.hasMethod(JasmineExtender_1.STATIC, "is", "Returns true if the object provided can be called a RDF Literal", [
            { name: "value", type: "any" }
        ...
        it(JasmineExtender_1.hasMethod(JasmineExtender_1.STATIC, "hasType", "Returns true if the Literal has the type indicated", [
    ...
    describe(JasmineExtender_1.clazz("Carbon.RDF.Literal.Util", "Class with useful functions for manage RDF Literals"), function () {
        it(JasmineExtender_1.isDefined(), function () {
            expect(Literal.Util).toBeDefined();
            expect(Utils.isFunction(Literal.Util)).toBe(true);
        });
        it(JasmineExtender_1.hasMethod(JasmineExtender_1.STATIC, "areEqual", "Returns true if two Literals are equal", [
    ...
    it(JasmineExtender_1.reexports(JasmineExtender_1.STATIC, "serializer", "Carbon/RDF/Literal/Serializers"), function () {
